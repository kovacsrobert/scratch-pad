...
public class ReplicationCacheManagerFactoryBean implements FactoryBean<CacheManager>, InitializingBean, DisposableBean {
    ...
    public void afterPropertiesSet() throws CacheException {
        ...
        configuration.addCacheManagerPeerProviderFactory(new ReplicationCacheManagerPeerProviderConfiguration());
